...
import com.kopykitab.gate.PremiumActivity;
import com.kopykitab.gate.R;
import com.kopykitab.gate.models.PremiumItem;
...
public class PremiumBooksAdapter extends RecyclerView.Adapter<PremiumBooksAdapter.MyViewHolder> {
    ...
    public PremiumBooksAdapter(PremiumActivity mContext, List<PremiumItem> premiumItemList) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            ((com.kopykitab.gate.components.TextView) premiumPrice1).setAddStrike(true);
