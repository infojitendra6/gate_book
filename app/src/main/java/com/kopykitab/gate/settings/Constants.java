...
public final class Constants {
    ...
    public static final String OFFICIAL_CALCULATOR_PATH = "file:///android_asset/gate-calculator/index.html";
    public static final String PRINT_ANNOTATION_FILE_NAME = "print_annotation.html";
    public static final String LOGIN_SOURCE = "android_app_GATE";
    public static final String FORMATTED_LOGIN_SOURCE = "GATE";
