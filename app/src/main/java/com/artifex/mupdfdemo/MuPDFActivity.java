...
import com.kopykitab.gate.components.CircularImageView;
import com.kopykitab.gate.components.ClearableEditText;
import com.kopykitab.gate.components.PagerSlidingTabStrip;
import com.kopykitab.gate.components.adapters.FindMoreBooksAdapter;
import com.kopykitab.gate.components.adapters.MuPdfItemClickListener;
import com.kopykitab.gate.components.adapters.NewFeatureAdapter;
...
public class MuPDFActivity extends AppCompatActivity implements FilePicker.FilePickerSupport, PopoverViewDelegate, MuPdfItemClickListener, DeleteAnnotationListener {
    ...
    public void OnMoreAnnotButtonClick(View view) {
        ...
        LinearLayout bookmark, notesAndBookmarks, shareThisBook;
        ...
        try {
            ...
            shareThisBook = (LinearLayout) moreAnnotationsView.findViewById(R.id.item_share_book);
            ...
            shareThisBook.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.i(TAG, "Share Book");
                    moreAnnotationsDropdown.dismiss();
